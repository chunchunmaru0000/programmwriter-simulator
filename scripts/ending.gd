...
var endings: Dictionary = {
	1: [
		'Неким утром, а может и вечером(вы были не в сознании) пару людей в военной форме выломали вам дверь и вошли в важу жилплощадь. Увидев вас в критическом состоянии вас срочно доставили в ближайший госпиталь.',
